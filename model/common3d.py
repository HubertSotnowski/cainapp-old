...
class ConvNorm(nn.Module):
    def __init__(self, in_feat, out_feat, kernel_size, stride=1, norm=False):
        ...
        self.conv = nn.Conv3d(in_feat, out_feat, stride=stride, kernel_size=(kernel_size,kernel_size,1), bias=True)
    ...
    def forward(self, x):
        ...
        out1 = self.reflection_pad(out[0])
        out2 = self.reflection_pad(out[1])
        #out3 = self.reflection_pad(out[2])
...
def conv3x3(in_channels, out_channels, stride=1, 
    ...
    return  nn.Conv3d(
        ...
        bias=bias,
        groups=groups)
def conv3x32(in_channels, out_channels, stride=1, 
            padding=1, bias=True, groups=1):    
    return  nn.Conv2d(
        in_channels,
        out_channels,
